...
class AnchorGenerator:
    ...
    def __init__(self,
        ...
        for i in range(self.num_levels):
            shift_x = torch.arange(0, feat_w, device="cuda", dtype=torch.float32) * stride
            shift_y = torch.arange(0, feat_h, device="cuda", dtype=torch.float32) * stride
    ...
    def single_level_grid_priors(self,
        ...
        shift_x, shift_y = self.shifts[level_idx]
